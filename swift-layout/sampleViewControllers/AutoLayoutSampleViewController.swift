...
class AutoLayoutSampleController: UIViewController {
    ...
    private func centerViews() -> UIView {
        ...
        let 右隣 = UILabel()
        右隣.text = "右隣"
        Layout.regist(右隣, superview: self.view)
        ...
        let 左隣 = UILabel()
        左隣.text = "左隣"
        Layout.regist(左隣, superview: self.view)
        ...
        let 上隣 = UILabel()
        上隣.text = "上隣"
        Layout.regist(上隣, superview: self.view)
        ...
        let 下隣 = UILabel()
        下隣.text = "下隣"
        Layout.regist(下隣, superview: self.view)
    ...
    private func middleViews(centerView:UIView) {
        ...
        let 左40 = UILabel()
        左40.text = "40"
        Layout.regist(左40, superview: self.view)
        ...
        let 右40 = UILabel()
        右40.text = "40"
        Layout.regist(右40, superview: self.view)
            .verticalCenterIsSame(centerView)
            .rightIsSame(右上40)
            .backgroundColor(color)
        ...
        let 上40 = UILabel()
        上40.text = "40"
        Layout.regist(上40, superview: self.view)
            .topIsSame(左上40)
        ...
        let 下40 = UILabel()
        下40.text = "40"
        Layout.regist(下40, superview: self.view)
            .bottomIsSame(右下40)
            .horizontalCenterIsSame(centerView)
            .backgroundColor(color)
    }
    ...
    private func cornerViews(centerView:UIView) {
        ...
        let lbl左 = UILabel()
        lbl左.text = "左"
        Layout.regist(lbl左, superview: self.view)
            .verticalCenterIsSame(centerView)
            .leftIsSame(lbl左上)
            .backgroundColor(color)
        ...
        let lbl右 = UILabel()
        lbl右.text = "右"
        Layout.regist(lbl右, superview: self.view)
            .verticalCenterIsSame(centerView)
            .rightIsSame(lbl右上)
            .backgroundColor(color)
        ...
        let lbl上 = UILabel()
        lbl上.text = "上"
        Layout.regist(lbl上, superview: self.view)
            .topIsSame(lbl左上)
            .horizontalCenterIsSame(centerView)
            .backgroundColor(color)
        ...
        let lbl下 = UILabel()
        lbl下.text = "下"
        Layout.regist(lbl下, superview: self.view)
            .bottomIsSame(lbl右下)
            .horizontalCenterIsSame(centerView)
            .backgroundColor(color)
    }
